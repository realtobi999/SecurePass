  ...
  <div class="mb-4">
      ...
      <input type="text" value = "{{ $keepData ? old('website') : '' }}" id="uri" name="uri" class="mt-1 p-2 block w-full border rounded-md bg-gray-100 ">
  </div>

  <!-- Username Input -->
  <div class="mb-4">
      <label for="username" class="block text-sm font-medium text-gray-600">Username</label>
      <input type="text" value = "{{ $keepData ? old('website') : '' }}" id="username" name="username" class="mt-1 p-2 block w-full border rounded-md bg-gray-100">
  </div>
