...
<div class="mb-4 relative" x-data="{ isVisible: false }">
    ...
    <div class="flex items-center">
        <input type="password" id="password" name="password" {{ $isRequired ? 'required' : '' }} class="mt-1 p-2 block w-full border rounded-md bg-gray-100 pr-10" x-bind:type="isVisible ? 'text' : 'password'">
